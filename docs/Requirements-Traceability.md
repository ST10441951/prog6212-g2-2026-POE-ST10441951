...
| SUB-02 | Complete six-column API endpoint plan | `/docs/API-Endpoint-Plan.md` | In progress: authentication, profiles, events, categories, routes and enrolments planned |
